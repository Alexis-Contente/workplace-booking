          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-gray-600">
                Discover more about the Workplace Booking application and how it
                works.
              </p>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-lg p-8">
              <div className="prose max-w-none">
                ...
                <p className="text-gray-700 mb-6">
                  ...
                  specifically for Quant Cube employees to reserve desk spaces
                  in our open office environment. Say goodbye to the hassle of
                ...
                <p className="text-gray-700 mb-4">
                  This modern application uses cutting-edge technologies to
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>
                        <strong>Row Level Security (RLS)</strong> - Data
                        security
                      </li>
                      <li>
                ...
                <p className="text-gray-700 mb-4">
                  This application was developed by Alexis Contente as a
                  personal project to improve the workplace experience at Quant
                  Cube.
                </p>
